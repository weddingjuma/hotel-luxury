    ...
    <div class="col-md-8">
        ...
        <div id="tribe-events-content" class="tribe-events-single">
            ...
            <div class="single-event-meta">
                <span class="event-time"><i class="fa fa-clock-o"></i> <?php echo tribe_events_event_schedule_details( $event_id ); ?></span>
            ...
            <div id="tribe-events-header" <?php tribe_events_the_header_attributes() ?>>
                <!-- Navigation -->
                <h3 class="tribe-events-visuallyhidden"><?php printf( esc_html__( '%s Navigation', 'hotel-luxury' ), $events_label_singular ); ?></h3>
